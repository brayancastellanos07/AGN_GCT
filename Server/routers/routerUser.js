...
const {getUsuario,getUsuarioActive, getUsuarioById,getAvatar, postUsuarios,login ,deleteUsuario,updateAvatar, updateUser} = require("../controllers/users/index.js");
...
router.put("/update-avatar/:id",[md_auth.ensureAuth],[md_update_avatar],updateAvatar);
